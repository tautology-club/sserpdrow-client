...
var signUp = function signUp(data) {
  console.log('sign up api data is ', data);
  return $.ajax({
...
var onUpdatePages = function onUpdatePages(event) {
  ...
  console.log(pageId);
  api.updatePages(data, pageId).then(ui.getUpdatePageSuccess).then(function () {
    return onGetMyPages(event);
...
var getUpdatePageSuccess = function getUpdatePageSuccess(data) {
...
var onUpdateBlogs = function onUpdateBlogs(event) {
  ...
  console.log(blogId);
  api.updateBlogs(data, blogId).then(ui.getUpdateBlogSuccess).then(function () {
    return onGetMyBlogs(event);
...
var getUpdateBlogSuccess = function getUpdateBlogSuccess(data) {
